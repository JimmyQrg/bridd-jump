...
function resetWorld(){
  // clear ALL arrays
  platforms.length = 0; spikes.length = 0; gems.length = 0; particles.length = 0;
  crashPieces.length = 0; trail.length = 0; lines.length = 0;
  cosmicDust.length = 0; energySpheres.length = 0; colorStreams.length = 0;
  spirals.length = 0; metallicParticles.length = 0; digitalRain.length = 0;
  mysticOrbs.length = 0; crystalStructures.length = 0; darkTendrils.length = 0;
  shockwaves.length = 0; screenDust.length = 0; bloomParticles.length = 0;
  reflections.length = 0; motionBlurBuffer.length = 0; lightRays.length = 0;
  parallaxLayers.length = 0; velocityStreaks.length = 0; impactWaves.length = 0;
  platformPulses.length = 0; windParticles.length = 0; speedLines.length = 0;
  lensFlares.length = 0; screenTears.length = 0; dynamicFog.length = 0;
  heatDistortions.length = 0; starbursts.length = 0; afterImages.length = 0;
  gravityWaves.length = 0; energyRipples.length = 0; pixelDisplacements.length = 0;
